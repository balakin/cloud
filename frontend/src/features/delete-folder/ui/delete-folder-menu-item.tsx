...
export type DeleteFolderMenuItemProps = {
  id: string;
  name: string;
  onDelete?: () => void;
};

export const DeleteFolderMenuItem: FC<DeleteFolderMenuItemProps> = ({ id, name, onDelete }) => {
  ...
  return (
    <>
      ...
      <Confirmation onYes={handleYes} onNo={handleNo} open={open}>
        <Typography>Are you sure you want to delete the "{name}" folder?</Typography>
      </Confirmation>
    </>
  );
};
